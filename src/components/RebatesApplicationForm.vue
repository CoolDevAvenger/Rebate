<template>
    ...
    <FormWizard
        ...
        <TabContent title="VALIDATION" ref="step5" :before-change="validateReview">
...
<script>
    ...
    // import StepValidate from './StepValidate.vue';
    ...
    export default {
        ...
        methods: {
            ...
            async validateReview() {
                const val1 = await this.validateStep1();
                const val2 = await this.validateStep2();
                const val3 = await this.validateStep3();
                const val4 = await this.validateStep4();
